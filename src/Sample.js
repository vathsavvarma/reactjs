...
const Sample = () => {
    return (
        ...
        <div className="flex items-center justify-center pa4">
            <a href="/reactjs" style={{marginTop:'50px'}}  className="f5 no-underline black bg-animate hover-bg-black hover-white inline-flex items-center pa3 ba border-box mr4">
